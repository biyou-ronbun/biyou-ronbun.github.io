...
この有名なフレーズの出典をたどると、皮膚のなかのペプチド濃度を実際に測っていたのは**マウス**でした。同じ研究のヒトのパートでは、血漿までしか測定されていません。

念のため、こちらでも探しました。使った検索式は、これです。

```
(collagen[tiab] AND (peptide[tiab] OR hydrolysate[tiab]))
  AND (oral[tiab] OR ingestion[tiab] OR ingested[tiab])
  AND ("skin biopsy"[tiab] OR dermis[tiab] OR "skin tissue"[tiab] OR "human skin"[tiab])
  AND humans[mh]
```

**返ってきたのは12件です。0件ではありません。ただし、12本とも、ヒトの皮膚の中のペプチドの量を測っていませんでした。**

中身は2種類でした。**肌の状態（水分量・弾力・シワ）を測った試験**か、**血液の中までを測った吸収試験**です。「飲んだ人の皮膚を採って、コラーゲン由来のペプチドがいくら届いていたかを測った」論文は、この12件の中にありません。

**検索語が引っかかることと、その論文が測っていることは、別です。** だから件数を隠さずに書きます。12件返ってきて、12本とも皮膚の中を測っていなかった。それが、こちらが見たものです。

この検索は、**記事の末尾から、あなたの画面で再実行できます。** 12件返ってくること、その中身が「肌のアウトカム」か「血中まで」であることを、ご自分で確かめてください。**私を信じる必要はありません。**
...
8. Yazaki M, Ito Y, Yamada M, et al. Oral Ingestion of Collagen Hydrolysate Leads to the Transportation of Highly Concentrated Gly-Pro-Hyp and Its Hydrolyzed Form of Pro-Hyp into the Bloodstream and Skin. J Agric Food Chem. 2017;65(11):2315-2322.（PMID: 28244315）

...
3グループなので1群20人です。非常に小さい試験です。そして**著者7人のうち6人が、キユーピー株式会社の研究開発本部の所属**です。論文の利益相反の欄にも、6人の名前が並んでいます。
...
### 使った検索式と、返ってきた件数を、そのまま出します

この記事は2つの検索の上に立っています。両方とも、隠さずに出します。

**1つめ。飲むヒアルロン酸のランダム化比較試験を探しました。**

```
"hyaluronic acid"[tiab] AND (oral[tiab] OR ingestion[tiab]) AND skin[tiab]
  AND "randomized controlled trial"[pt]
```

**返ってきたのは12件です。0件ではありません。飲むヒアルロン酸のRCTは、確かに存在します。**

ここは誤解されやすいので、はっきり書きます。この記事は「試験が無い」とは一度も書いていません。書いたのは「**今回一次情報で確認できたRCTが、1本残らずメーカーの資金か社員によるものだった**」です。12件返ってくることと、この記事の主張は、矛盾しません。

**2つめ。「飲んだヒアルロン酸が皮膚に届く」を、ヒトで測った研究を探しました。**

```
("hyaluronic acid"[tiab] OR hyaluronan[tiab]) AND (oral[tiab] OR ingest*[tiab] OR dietary[tiab])
  AND (dermis[tiab] OR "skin biopsy"[tiab] OR "skin tissue"[tiab] OR "skin concentration"[tiab])
  AND humans[mh]
```

**返ってきたのは11件。ただし、11本とも、ヒトの皮膚の中のヒアルロン酸の量を測っていませんでした。**

中身は、**注入したフィラーの研究、マイクロニードル（針で皮膚に入れる方法）の研究、そして培養細胞や試験管の実験**でした。「飲んだ人の皮膚を採って、ヒアルロン酸がいくら届いていたかを測った」論文は、この11件の中に1本もありません。

「11件も出たなら、あるんじゃないの?」と思われたかもしれません。**検索語が引っかかることと、その論文が測っていることは、別です。** だから件数を隠さず、検索式ごと出します。

この2つの検索は、**記事の末尾から、あなたの画面で再実行できます。** 12件と11件が返ってくること、そして11件がヒトの皮膚の中を測っていないことを、ご自分で確かめてください。**私を信じる必要はありません。**

...
//
// ②は「公開待ち」です。公開日が来るまで、その記事はどこにも出ません。
// 日付が来たら、自動で全員に出ます。
//
// ★ 以前は、この期間だけメンバーのページに先行公開していました（先出し）。
//   2026-07-14、その約束を消しました。記事は当日の日付で公開されるので先出しが
//   一度も発生せず、「払った人が見るページが空になる」約束だったからです。
//   いまは日付を見て寝かせているだけで、メンバー向けの特別扱いはありません。
